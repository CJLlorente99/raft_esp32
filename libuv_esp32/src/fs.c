...
int uv_fs_close(uv_loop_t *loop, uv_fs_t *req, uv_file file, uv_fs_cb cb)
{
    ...
    if(loop && cb){
        ...
        if (rv != 0)
        {
            ESP_LOGE("UV_FS_CLOSE", "Error during insert in uv_fs_close");
            return 1;
        }
    }
...
int uv_fs_rename(uv_loop_t *loop, uv_fs_t *req, const char *path, const char *new_path, uv_fs_cb cb)
{
    ...
    if(loop && cb){
        ...
        if (rv2 != 0)
        {
            ESP_LOGE("UV_FS_RENAME", "Error during insert in uv_fs_rename");
            return 1;
        }
    }
...
int uv_fs_fsync(uv_loop_t *loop, uv_fs_t *req, uv_file file, uv_fs_cb cb)
{
    ...
    if(loop && cb){
        ...
        if (rv2 != 0)
        {
            ESP_LOGE("UV_FS_FSYNC", "Error during insert in uv_fs_rename");
            return 1;
        }
    }
...
int uv_fs_ftruncate(uv_loop_t *loop, uv_fs_t *req, uv_file file, int64_t offset, uv_fs_cb cb)
{
    ...
    if(loop && cb){
        ...
        if (rv2 != 0)
        {
            ESP_LOGE("UV_FS_FTRUNCATE", "Error during insert in uv_fs_ftruncate");
            return 1;
        }
    }
...
int uv_fs_unlink(uv_loop_t *loop, uv_fs_t *req, const char *path, uv_fs_cb cb)
{
    ...
    if(loop && cb){
        ...
        if (rv2 != 0)
        {
            ESP_LOGE("UV_FS_UNLINK", "Error during insert in uv_fs_unlink");
            return 1;
        }
    }
